 ...
 * @author dappo
 */
@WebServlet(name = "OficinasWS", urlPatterns = {"/admin/oficina/OficinasWS"})
public class OficinasWS extends HttpServlet {
    private OficinasDAO dao;
    private Oficinas obj;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(String.valueOf(acao)){
            ...
            case "edit":
                id = request.getParameter("id");
                dao = new OficinasDAO();
                Oficinas obj = dao.buscarPorChavePrimaria(Long.parseLong(id));
            ...
            default:
                ...
                if (request.getParameter("filtro") != null) {
                    try {
                        ...
                        Logger.getLogger(OficinasWS.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    lista = dao.listar();
                }
